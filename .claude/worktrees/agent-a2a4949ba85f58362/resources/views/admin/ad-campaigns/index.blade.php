...
@section('content')
    ...
    <div class="mb-6 flex items-center justify-between gap-4">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-0.5">{{ __('admin.ad_campaigns.subtitle') }}</p>
        </div>
    ...
    <div class="flex border-b border-gray-200 mb-5 gap-1">
        @foreach([
            'all'      => __('admin.ad_campaigns.all_campaigns'),
            ...
            <table id="campaigns-table" class="w-full text-sm" style="width:100%">
                <thead>
                    <tr class="border-b border-gray-100 text-start">
                        ...
                        <th class="py-2 pr-4 text-xs font-medium text-gray-500 uppercase">{{ __('admin.ad_campaigns.campaign') }}</th>
    ...
    <x-modal id="approve-modal" title="{{ __('admin.ad_campaigns.approve_campaign') }}" size="sm">
        <p class="text-sm text-gray-600">
            {{ __('admin.ad_campaigns.approve_confirm_prefix') }} <strong id="approve-campaign-name"></strong>
            {{ __('admin.ad_campaigns.approve_confirm_suffix') }}
        </p>
    ...
    <x-modal id="reject-modal" title="{{ __('admin.ad_campaigns.reject_campaign') }}" size="md">
        <p class="text-sm text-gray-600 mb-3">
            {{ __('admin.ad_campaigns.reject_confirm_prefix') }} <strong id="reject-campaign-name"></strong>.
        </p>
