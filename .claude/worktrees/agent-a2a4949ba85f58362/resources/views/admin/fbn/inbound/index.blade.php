...
@section('title', __('admin.fbn_section.title'))
...
<div class="bg-white rounded-2xl border border-gray-100 p-4 mb-4 flex flex-wrap gap-3 items-end">
    <div>
        <label class="label-sm">{{ __('common.status') }}</label>
...
<div class="bg-white rounded-2xl border border-gray-100 overflow-hidden">
    <table id="tbl-inbound" class="w-full text-sm">
        <thead class="bg-gray-50 text-xs text-gray-500 uppercase">
            <tr>
                <th class="px-4 py-3 text-start">{{ __('admin.fbn_section.inbound_id') }}</th>
                ...
                <th class="px-4 py-3 text-start">Warehouse</th>
                <th class="px-4 py-3 text-start">Qty (Req / Rcvd)</th>
                ...
                <th class="px-4 py-3 text-start">{{ __('admin.created_at') }}</th>
...
<div id="approve-modal" class="modal" style="display:none;">
    <div class="modal-box max-w-sm">
        <h3 class="font-bold text-lg mb-4">{{ __('admin.approve') }} {{ __('admin.fbn_section.inbound') }}</h3>
        ...
        <div class="flex gap-3 justify-end mt-5 pt-4 border-t">
            <button type="button" id="approve-close" class="btn btn-ghost btn-sm">{{ __('common.cancel') }}</button>
            <button type="button" id="approve-confirm" class="btn btn-success btn-sm">{{ __('admin.approve') }}</button>
        </div>
    </div>
</div>
...
<div id="reject-modal" class="modal" style="display:none;">
    <div class="modal-box max-w-sm">
        <h3 class="font-bold text-lg mb-4">{{ __('admin.reject') }} {{ __('admin.fbn_section.inbound') }}</h3>
        ...
        <div class="flex gap-3 justify-end mt-5 pt-4 border-t">
            <button type="button" id="reject-close" class="btn btn-ghost btn-sm">{{ __('common.cancel') }}</button>
            <button type="button" id="reject-confirm" class="btn btn-danger btn-sm">{{ __('admin.reject') }}</button>
        </div>
    </div>
</div>
...
<div id="tracking-modal" class="modal" style="display:none;">
    <div class="modal-box max-w-sm">
        ...
        <div class="flex gap-3 justify-end mt-5 pt-4 border-t">
            <button type="button" id="tracking-close" class="btn btn-ghost btn-sm">{{ __('common.cancel') }}</button>
            <button type="button" id="tracking-confirm" class="btn btn-primary btn-sm">{{ __('common.save') }} &amp; Mark Shipped</button>
        </div>
    </div>
</div>
...
<div id="receive-modal" class="modal" style="display:none;">
    <div class="modal-box max-w-sm">
        <h3 class="font-bold text-lg mb-4">{{ __('admin.fbn_section.received_at') }}</h3>
        ...
        <div class="flex gap-3 justify-end mt-5 pt-4 border-t">
            <button type="button" id="receive-close" class="btn btn-ghost btn-sm">{{ __('common.cancel') }}</button>
            <button type="button" id="receive-confirm" class="btn btn-success btn-sm">{{ __('common.confirm') }} Receipt</button>
        </div>
    </div>
</div>
