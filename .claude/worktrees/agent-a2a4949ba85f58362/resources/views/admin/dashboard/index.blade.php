    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-0.5">{{ __('admin.dashboard.vs_last_period') }}</p>
            </div>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-4">
            ...
            <x-card class="xl:col-span-2" padding="none">
                <div class="flex items-center justify-between px-5 py-4 border-b border-gray-100">
                    <h3 class="font-semibold text-gray-900">{{ __('admin.dashboard.revenue_trend') }}</h3>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-4">
                    ...
                    <table class="min-w-full text-sm">
                        <thead>
                            <tr class="border-b border-gray-100 bg-gray-50">
                                ...
                                <th
                                    class="px-5 py-3 text-start text-xs font-semibold text-gray-500 uppercase tracking-wider">
                                    {{ __('admin.dashboard.waiting_time') }}</th>
                            </tr>
                        </thead>
            ...
            <x-card padding="none">
                <div class="px-5 py-4 border-b border-gray-100">
                    ...
                    <p class="text-xs text-gray-400 mt-0.5">{{ __('admin.dashboard.risk_assessment') }}</p>
                </div>
                <ul id="pending-list" class="divide-y divide-gray-100">
                    <li class="px-5 py-3 flex items-center justify-between hover:bg-gray-50 transition-colors">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500">{{ __('admin.products.approval_pending') }}</p>
                            </div>
                        </div>
                    ...
                    <li class="px-5 py-3 flex items-center justify-between hover:bg-gray-50 transition-colors">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500">{{ __('admin.dashboard.pending_vendor_apps') }}</p>
                            </div>
                        </div>
                    ...
                    <li class="px-5 py-3 flex items-center justify-between hover:bg-gray-50 transition-colors">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500">{{ __('admin.disputes_section.open') }}</p>
                            </div>
                        </div>
                    ...
                    <li class="px-5 py-3 flex items-center justify-between hover:bg-gray-50 transition-colors">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-sm font-medium text-gray-900">{{ __('admin.wallets_section.withdrawal_requests') }}</p>
                                <p class="text-xs text-gray-500">{{ __('admin.payouts_section.title') }}</p>
                            </div>
                        </div>
                    ...
                    <li class="px-5 py-3 flex items-center justify-between hover:bg-gray-50 transition-colors">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-sm font-medium text-gray-900">{{ __('admin.refunds') }}</p>
                                <p class="text-xs text-gray-500">{{ __('admin.orders.process_refund') }}</p>
                            </div>
                        </div>
            ...
            <x-card padding="none">
                <div class="flex items-center justify-between px-5 py-4 border-b border-gray-100">
                    <div>
                        ...
                        <p class="text-xs text-gray-400 mt-0.5">{{ __('admin.dashboard.sales') }}</p>
                    </div>
            ...
            <x-card padding="none">
                <div class="flex items-center justify-between px-5 py-4 border-b border-gray-100">
                    <div>
                        ...
                        <p class="text-xs text-gray-400 mt-0.5">{{ __('admin.dashboard.threshold') }}</p>
                    </div>
                    <a href="{{ route('admin.products.index') }}"
                        class="text-sm text-primary-600 hover:text-primary-700 font-medium">{{ __('admin.view') }} →</a>
                </div>
                <div class="overflow-x-auto">
                    <table class="min-w-full text-sm">
                        <thead>
