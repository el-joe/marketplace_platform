...
class PaidAdBookingController extends Controller
{
    ...
    public function datatable(Request $request): JsonResponse
    {
        ...
        $columns = [
            ...
            ['searchable_columns' => [], 'orderable_column' => 'agreed_rate_cents'],
        ...
        return $this->dataTableResponse($request, $query, $columns, function (PaidAdBooking $row) use ($statusColors, $paymentColors, $canEdit) {
            ...
            return [
                ...
                'rate' => '$' . number_format($row->agreed_rate_cents / 100, 2) . ' <span class="text-xs text-gray-400">' . strtoupper($row->currency ?? 'USD') . '</span>',
                'status' => $statusBadge,
