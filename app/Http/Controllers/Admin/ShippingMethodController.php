...
class ShippingMethodController extends Controller
{
    ...
    {
        $methods = ShippingMethod::withCount('countrySettings')->orderBy('name')->get();
        ...
        return view('admin.shipping-methods.index', compact('methods', 'carriers', 'countries', 'zones'));
    }
    ...
    public function storeMethod(Request $request): JsonResponse
    {
        ...
        return response()->json(['success' => true, 'message' => 'Shipping method created.', 'data' => $method], 201);
    }
    ...
    public function updateMethod(Request $request, ShippingMethod $method): JsonResponse
    {
        $data = $request->validate([
            ...
            'code' => ['sometimes', 'required', 'string', 'max:50', 'unique:shipping_methods,code,' . $method->id],
            'description' => ['nullable', 'string'],
        ...
        return response()->json(['success' => true, 'message' => 'Shipping method updated.', 'data' => $method->fresh()]);
    }

    public function toggleMethod(ShippingMethod $method): JsonResponse
    {
