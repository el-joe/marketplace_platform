...
class WarrantyPlanController extends Controller
{
    ...
    public function datatableData(Request $request): JsonResponse
    {
        $columns = [
            ...
            ['title' => 'Price', 'data' => 'price_display', 'name' => 'price_display', 'orderable_column' => 'warranty_plans.price_cents', 'searchable' => false],
        ...
        return $this->dataTableResponse($request, $query, $columns, function (WarrantyPlan $plan) {
            return [
                ...
                'price_display' => number_format($plan->price_cents / 100, 2) . ' ' . e($plan->currency),
