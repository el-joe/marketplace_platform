...
<head>
    ...
    <title>تسجيل دخول | بوابة شركات الشحن</title>
...
<body class="min-h-screen bg-gradient-to-br from-indigo-50 to-slate-100 flex items-center justify-center" style="font-family: 'Cairo', sans-serif;">
    ...
    <div class="w-full max-w-md">
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-black text-gray-900">بوابة شركات الشحن</h1>
            <p class="text-gray-500 text-sm mt-1">سجّل دخولك للوصول إلى لوحة التحكم</p>
        </div>
