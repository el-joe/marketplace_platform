...
<div class="mb-4 flex items-center gap-1 border-b border-gray-200">
    ...
    <a href="{{ route('carrier.reports.earnings') }}" class="px-4 py-2 text-sm font-bold text-indigo-600 border-b-2 border-indigo-600">{{ __('carrier.reports.tab_earnings') }}</a>
