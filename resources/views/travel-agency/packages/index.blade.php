                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 flex gap-2">
                                <a href="{{ route('travel-agency.packages.show', $pkg) }}"
                                    class="text-blue-600 text-xs hover:underline">عرض</a>
                                @if(in_array($pkg->status, ['draft', 'pending_review']))
                                    <a href="{{ route('travel-agency.packages.edit', $pkg) }}"
                                        class="text-amber-600 text-xs hover:underline">تعديل</a>
                                @endif
                            </td>
                        </tr>
                    @empty
                        <tr>
                            <td colspan="7" class="px-4 py-10 text-center text-gray-400 text-sm">
                                لا توجد باقات بعد.
                                <a href="{{ route('travel-agency.packages.create') }}" class="text-blue-600 hover:underline">أضف
                                    أول باقة</a>
                            </td>
                        </tr>
                    @endforelse
