...
<div class="max-w-3xl space-y-6">
    <div class="flex items-center gap-4">
        <a href="{{ route('travel-agency.packages.index') }}" class="text-gray-400 hover:text-gray-600">← رجوع</a>
        <h1 class="text-2xl font-black text-gray-900">إضافة باقة سياحية جديدة</h1>
    </div>
