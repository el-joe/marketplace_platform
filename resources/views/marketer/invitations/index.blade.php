...
<form method="GET" action="{{ route('marketer.invitations.index') }}" class="flex flex-wrap items-end gap-3 mb-4 bg-white rounded-2xl border border-gray-100 p-4">
    <div>
        ...
        <select name="status" class="w-full rounded-lg border-gray-200 text-sm mt-1">
            ...
            @foreach(\App\Enums\VendorCampaignInvitationStatus::cases() as $status)
