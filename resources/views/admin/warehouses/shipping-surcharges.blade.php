...
@section('title', 'Warehouse Shipping Surcharges')
...
@section('content')
    ...
    <div class="mb-6 flex items-center justify-between">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-0.5">Add an extra flat shipping amount for products shipped from a warehouse.</p>
        </div>
        <div class="flex items-center gap-2">
            <a href="{{ route('admin.warehouses.index') }}" class="btn-secondary btn-sm">Back to Warehouses</a>
    ...
    <div class="mb-4 rounded-lg border border-primary-200 bg-primary-50 px-4 py-3 text-sm text-primary-800">
        When an order is fulfilled from a warehouse below (network-fulfilled / FBN), this extra amount is added on top of normal shipping.
    </div>
    ...
    <x-modal id="warehouse-surcharge-modal" title="Warehouse Shipping Surcharge" size="md">
        <form id="warehouse-surcharge-form" novalidate>
            ...
            <div class="grid grid-cols-1 gap-4">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Extra Shipping Amount <span class="text-danger-500">*</span></label>
            ...
            <x-slot:footer>
                ...
                <button type="submit" form="warehouse-surcharge-form" class="btn-primary">Save</button>
            </x-slot:footer>
        </form>
    </x-modal>
