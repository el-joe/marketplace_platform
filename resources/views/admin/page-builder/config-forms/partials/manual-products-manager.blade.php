...
<section class="pt-4 mt-4 border-t border-gray-200">
    <div class="flex items-center justify-between mb-2">
        <h4 class="text-xs font-semibold uppercase tracking-wide text-gray-500">Manual products</h4>
    </div>
    ...
    <div class="relative mb-3">
        <input type="search"
            ...
            placeholder="Search products…" data-action="search-block-products" data-block-id="{{ $block?->id }}" />
