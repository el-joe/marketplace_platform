...
<section class="pt-4 mt-4 border-t border-gray-200">
    <div class="flex items-center justify-between mb-2">
        <h4 class="text-xs font-semibold uppercase tracking-wide text-gray-500">Slides</h4>
        <button type="button"
            ...
            <x-heroicon name="plus" class="w-3.5 h-3.5" /> Add slide
        </button>
    </div>
    ...
    <div data-slides-list
        ...
        <div class="text-xs text-gray-400 px-2 py-3 text-center">Loading slides…</div>
    </div>
</section>
