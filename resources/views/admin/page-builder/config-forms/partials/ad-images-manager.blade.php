...
<section class="pt-4 mt-4 border-t border-gray-200">
    <div class="flex items-center justify-between mb-2">
        <h4 class="text-xs font-semibold uppercase tracking-wide text-gray-500">Ad images</h4>
        <button type="button"
            ...
            <x-heroicon name="plus" class="w-3.5 h-3.5" /> Add image
        </button>
    </div>

    <div data-ad-images-list data-block-id="{{ $block?->id }}" class="space-y-1 text-sm text-gray-500">
        <div class="text-xs text-gray-400 px-2 py-3 text-center">Loading images…</div>
    </div>
</section>