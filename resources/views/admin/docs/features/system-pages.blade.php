@component('admin.docs._layout', ['title' => __('docs/features/system-pages.title'), 'icon' => '⚙️', 'breadcrumb' => __('docs/features/system-pages.breadcrumb')])
    ...
    <div class="prose prose-sm max-w-none space-y-10">
        ...
        <section>
            ...
            <p class="text-gray-600"><a href="{{ route('admin.payment-methods.index') }}" class="text-primary-600 hover:underline">admin/payment-methods</a>: {{ __('docs/features/system-pages.payment_methods.body') }}</p>
        </section>
