...
@section('title', 'Vendor Campaign Offers')

@section('content')

    <div class="mb-6 flex items-center justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Vendor Campaign Offers</h1>
    ...
    <x-card class="mb-5">
        <form id="filter-form" class="flex flex-wrap gap-3 items-end">
            ...
            <div class="w-36">
                <label class="block text-xs font-medium text-gray-600 mb-1">Ends before</label>
                <input type="date" id="filter-date-to" class="form-input w-full text-sm">
            </div>
            <button type="button" id="filter-reset" class="btn btn-secondary btn-sm self-end">Reset</button>
        </form>
    </x-card>
        ...
        <table id="offers-table" class="w-full text-sm" style="width:100%">
            <thead>
                <tr class="text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">
                    ...
                    <th class="pb-3 pr-3">Commission</th>
