<div class="js-nav-slot flex-1 min-w-0 border border-gray-200 rounded-xl p-3 cursor-pointer hover:border-primary-400 hover:shadow-sm transition-colors"
    ...
    <div class="flex items-center justify-center h-10 w-10 mx-auto rounded-lg {{ optional($item)->is_center_featured ? 'bg-primary-600 text-white' : 'bg-gray-100 text-gray-600' }}">
