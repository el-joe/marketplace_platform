            ...
            <div class="flex-1 min-w-0 space-y-5">
                <x-card title="{{ __('admin.helpcenter.title') }}">
                    <div class="p-6 space-y-5">
                        <div>
                            <label class="form-label">{{ __('admin.helpcenter.article_title') }} <span class="text-red-500">*</span></label>
                        ...
                        <div>
                            <div class="flex justify-between mb-1">
                                <label class="form-label">{{ __('admin.helpcenter.excerpt') }}</label>
                            ...
                            <textarea name="excerpt" id="excerpt" rows="2" maxlength="500"
                                      class="form-textarea w-full @error('excerpt') is-invalid @enderror"
                                      placeholder="{{ __('admin.helpcenter.excerpt_placeholder') }}">{{ old('excerpt') }}</textarea>
                        ...
                        <div>
                            <x-form.rich-editor
                                name="body"
                                label="{{ __('admin.helpcenter.body') }}"
                                :required="true"
                                profile="full"
                                :minHeight="400"
                                :value="old('body', '')"
