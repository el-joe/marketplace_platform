...
@section('content')
                    ...
                    <div class="flex items-center border-b px-4">
                        ...
                        <div class="ml-auto flex items-center gap-2 py-2">
                            ...
                            <button id="copy-rates-btn" class="btn btn-ghost btn-sm" x-show="activeTab === 'rates'"
                                title="Copy rates from another zone">
                                📋 Copy from zone
                            </button>
                        </div>
                    </div>
                        ...
                        <div class="px-4 py-2 border-b bg-gray-50 flex flex-wrap items-center gap-3">
                            ...
                            <div id="bulk-actions" class="hidden flex items-center gap-2 ml-auto">
                                ...
                                <button id="bulk-deactivate"
                                    class="btn btn-xs btn-ghost text-yellow-600">Deactivate</button>
            ...
            <div class="px-6 py-4">
                <form id="zone-form" class="space-y-4">
                    ...
                    <x-form.textarea name="description" label="Description (optional)" :rows="2"
                        placeholder="Cities covered by this zone" />
        ...
        <div class="modal-panel modal-lg">
            ...
            <div class="px-6 py-4">
                <form id="rate-form" class="space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="space-y-1">
                            <label class="block text-sm font-medium text-gray-700">Shipping method <span
                                    class="text-red-500">*</span></label>
                    ...
                    <div class="bg-gray-50 rounded-lg border border-gray-200 p-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Free shipping from
                                    (optional)</label>
                    ...
                    <details class="bg-gray-50 rounded-lg border border-gray-200">
                        <summary class="px-4 py-3 text-sm font-medium text-gray-700 cursor-pointer select-none">Advanced
                            settings</summary>
    ...
    <div id="assign-cities-modal" class="modal-backdrop hidden" role="dialog" aria-modal="true">
        <div class="modal-panel modal-lg">
            <div class="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
                <h3 class="text-base font-semibold text-gray-900">Assign cities to zone: <span
            ...
            <div class="px-6 py-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <div class="flex items-center justify-between mb-2">
                            <p class="text-sm font-semibold text-gray-700">In this zone (<span id="assigned-count">0</span>)
                            </p>
    ...
    <div id="duplicate-zone-modal" class="modal-backdrop hidden" role="dialog" aria-modal="true">
        <div class="modal-panel modal-sm">
            ...
            <div class="px-6 py-4 space-y-3">
                ...
                <p class="text-xs text-gray-500">All rates from this zone will be copied as inactive. Cities will NOT be
                    copied.</p>
                <div class="flex justify-end gap-2">
                    <button data-modal-close class="btn btn-ghost btn-sm">Cancel</button>
