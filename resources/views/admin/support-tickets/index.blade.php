...
@section('content')
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-5">
        ...
        <x-stat-card title="In Progress" :value="number_format($stats['in_progress'])" iconBg="bg-blue-100 text-blue-600" />
        <x-stat-card title="Urgent" :value="number_format($stats['urgent'])"
    ...
    <x-card class="mb-5">
        <div class="flex flex-wrap gap-3 items-end">
            <div class="flex-1 min-w-[180px]">
                <label class="block text-xs font-medium text-gray-600 mb-1">Search ticket # / subject</label>
            ...
            <table id="support-tickets-table" data-url="{{ route('admin.support-tickets.datatable') }}"
                ...
                <thead>
                    <tr class="text-left text-xs font-medium text-gray-500 border-b border-gray-200">
                        <th class="pb-3 pr-4 whitespace-nowrap">Ticket #</th>
                        <th class="pb-3 pr-4 whitespace-nowrap">Requester</th>
                        <th class="pb-3 pr-4 whitespace-nowrap">Category</th>
                        <th class="pb-3 pr-4 whitespace-nowrap">Priority</th>
                        ...
                        <th class="pb-3 pr-4 whitespace-nowrap">Response</th>
