...
<div class="space-y-4">
    ...
    <div>
        ...
        <p x-show="cities.length === 0 && form.country_id" class="mt-1 text-xs text-[#feee00]" x-cloak>{{ $isAr ? 'لا توجد مدن مسجلة لهذه الدولة حالياً.' : 'No cities are currently registered for this country.' }}</p>
    </div>
