...
<section id="listings" class="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="rounded-2xl overflow-hidden bg-[#1c1c1c] lg:grid lg:grid-cols-[1.5fr_2fr]">
        ...
        <div class="pt-8 px-6 pb-8 md:pt-10 md:px-10 md:pb-10">
            ...
            <h4 class="text-yellow-400 font-black text-sm mt-6 mb-3">{{ $isAr ? 'خيارات التحميل:' : 'Upload options:' }}</h4>
            ...
            <a target="_blank" rel="noopener" title="{{ $isAr ? 'يفتح في نافذة جديدة' : 'Opens in a new window' }}"
               ...
               class="inline-block border border-gray-600 hover:border-yellow-400 text-white text-sm font-bold px-5 py-2.5 rounded-full transition-colors">
    ...
    <div class="grid gap-6 lg:gap-8 lg:grid-cols-[2fr_1fr] lg:items-start">
        ...
        <div class="rounded-2xl overflow-hidden bg-[#1c1c1c] lg:grid lg:grid-cols-[1.5fr_2fr] h-full">
            ...
            <div class="pt-8 px-6 pb-8 md:pt-10 md:px-10 md:pb-10">
                <p class="text-yellow-400 font-black text-xs uppercase tracking-wider">
                ...
                <h5 class="text-yellow-400 font-black text-sm mb-2">{{ $isAr ? 'وكيل معتمد؟' : 'Authorised agent?' }}</h5>
                ...
                <h5 class="text-yellow-400 font-black text-sm mb-2">{{ $isAr ? 'موزع؟' : 'Distributor?' }}</h5>
                ...
                <h5 class="text-yellow-400 font-black text-sm mb-2">{{ $isAr ? 'قدمت طلبك؟' : 'Already applied?' }}</h5>
                ...
                <a href="{{ route('portal.faq') }}"
                   class="inline-block bg-yellow-400 hover:bg-yellow-300 text-black font-black text-sm px-6 py-2.5 rounded-full transition-colors">
        ...
        <div class="rounded-2xl overflow-hidden border-2 border-[#1c1c1c] h-full">
            ...
            <div class="pt-7 px-6 pb-8">
                ...
                <p class="text-yellow-400 font-black text-xs uppercase tracking-wider mt-5">{{ $isAr ? 'تنبيه:' : 'Heads up:' }}</p>
                ...
                <a href="{{ route('portal.faq') }}"
                   class="inline-block mt-8 bg-yellow-400 hover:bg-yellow-300 text-black font-black text-sm px-6 py-2.5 rounded-full transition-colors">
