@php
    ...
    $solutions = [
        ...
        [
            ...
            'title_en' => 'Brand Ads',
            'desc_ar' => 'قم بالترويج لمنتجاتك وعلامتك التجارية بطريقة بصرية جذابة وبارزة داخل صفحات نون للتصفح، البحث، وصفحات تفاصيل المنتج ذات الصلة. بمكنك أيضًا عرض منتجات متعددة داخل إعلان واحد، لإبراز مجموعة واسعة من منتجاتك وجذب جمهور أكبر.',
        ...
        [
            ...
            'desc_ar' => 'قم بتعزيز رؤية منتجاتك في الأسفل باستخدام الإعلانات المستهدفة التي تصل إلى قاعدة عملاء أكبر وتمكن النمو. سيعمل هذا المنتج على زيادة ظهور منتجاتك بشكل كبير، والوصول إلى العملاء، وإمكانات التحويل.',
        ...
        [
            ...
            'desc_ar' => 'قم بجذب الملايين من المتسوقين من خلال حلول الإعلان الخارجي ذات التأثير العالي والتي تم وضعها بشكل استراتيجي في مواقع ذات حركة مرور كبيرة، وهي مصممة خصيصًا لجمهورك المستهدف. أو يمكنك أن تذهب مباشرة إليهم عبر تسويق تحت الخط (BTL) الشخصي والمستهدف.',
