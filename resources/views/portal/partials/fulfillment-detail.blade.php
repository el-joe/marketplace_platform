...
<section id="fbn" class="mt-[48px] md:bg-[#1c1c1c] md:py-10 lg:py-12">
    <div class="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
        <h2 class="text-2xl sm:text-[32px] font-extrabold mb-6 lg:mb-8">
            <span class="text-yellow-400">{{ $isAr ? 'التنفيذ من قبل نون:' : 'Fulfilled by noon:' }}</span>
        ...
        <div class="bg-[#1c1c1c] rounded-2xl overflow-hidden md:grid md:grid-cols-[1.5fr_2fr] md:gap-10 lg:gap-14">
            ...
            <div class="pt-7 px-6 pb-10 md:px-0 md:py-6">
                ...
                <p class="mt-5 text-yellow-400 font-black text-xs uppercase tracking-wider">{{ $isAr ? 'الإضافة:' : "What's included:" }}</p>
                ...
                <p class="mt-4 text-yellow-400 font-black text-xs uppercase tracking-wider">{{ $isAr ? 'مثالي لـ:' : 'Ideal for:' }}</p>
                <p class="mt-1 text-gray-300 font-medium">
                ...
                <a href="{{ route('portal.register') }}"
                   class="inline-flex items-center mt-8 bg-yellow-400 hover:bg-yellow-300 text-black
...
<div class="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 mt-[24px] md:mt-[48px]">
    <section class="rounded-2xl border-2 border-[#1c1c1c] overflow-hidden md:flex md:flex-row-reverse md:items-center md:gap-10 md:p-10">
        ...
        <div class="px-6 pb-8 md:flex-1 md:p-0">
            ...
            <p class="mt-4 text-xs font-bold text-yellow-400">- {{ $isAr ? 'أفلاك الثريا' : 'Aflak Al Thurayya' }}</p>
        </div>
    </section>
</div>
...
<section id="fbp" class="mt-[48px] md:bg-[#1c1c1c] md:py-10 lg:py-12">
    <div class="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
        <h2 class="text-2xl sm:text-[32px] font-extrabold mb-6 lg:mb-8">
            <span class="text-yellow-400">{{ $isAr ? 'التنفيذ من قبل الشريك:' : 'Fulfilled by partner:' }}</span>
        ...
        <div class="bg-[#1c1c1c] rounded-2xl overflow-hidden md:grid md:grid-cols-[1.5fr_2fr] md:gap-10 lg:gap-14">
            ...
            <div class="pt-7 px-6 pb-10 md:px-0 md:py-6">
                ...
                <p class="mt-5 text-yellow-400 font-black text-xs uppercase tracking-wider">{{ $isAr ? 'مثالي لـ:' : 'Ideal for:' }}</p>
                <p class="mt-1 text-gray-300 font-medium">
...
<div class="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 mt-[24px] md:mt-[48px] mb-[96px]">
    <section class="rounded-2xl border-2 border-[#1c1c1c] overflow-hidden md:flex md:flex-row-reverse md:items-center md:gap-10 md:p-10">
        ...
        <div class="px-6 pb-8 md:flex-1 md:p-0">
            ...
            <p class="mt-4 text-xs font-bold text-yellow-400">- {{ $isAr ? 'حكايات سحاب' : 'Hekayat Sahab' }}</p>
        </div>
    </section>
</div>
