...
@section('title', __('partner.campaign_offers.new_offer_title'))
...
<div class="px-4 py-6 sm:px-6 lg:px-8">
    ...
    <nav class="mb-6 flex items-center gap-2 text-sm text-gray-500">
        ...
        <span class="text-gray-800 font-medium">{{ __('partner.campaign_offers.new_offer') }}</span>
    </nav>
    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="mb-8 flex items-center justify-between" id="step-indicators">
            @foreach ([
                ['num' => 1, 'label' => __('partner.campaign_offers.steps.campaign_details')],
                ['num' => 2, 'label' => __('partner.campaign_offers.steps.commission_budget')],
                ['num' => 3, 'label' => __('partner.campaign_offers.steps.products')],
            ] as $step)
        ...
        <form id="campaign-offer-form" method="POST" action="{{ route('partner.campaign-offers.store') }}" class="space-y-6" novalidate>
            ...
            <div class="step-panel" data-panel="1">
                <div class="rounded-xl border border-gray-200 bg-white shadow-sm divide-y divide-gray-100">
                    <div class="px-6 py-4">
                        <h2 class="text-base font-semibold text-gray-900">{{ __('partner.campaign_offers.steps.campaign_details') }}</h2>
                    </div>
                    <div class="px-6 py-5 space-y-5">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1.5" for="name">
                                {{ __('partner.campaign_offers.name_label') }} <span class="text-red-500">*</span>
                            </label>
                            <input type="text" id="name" name="name" value="{{ old('name') }}" maxlength="255" required
                                   ...
                                   placeholder="{{ __('partner.campaign_offers.name_placeholder') }}">
                        </div>

                        {{-- Campaign Type --}}
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1.5" for="campaign_type">
                                {{ __('partner.campaign_offers.type_label') }} <span class="text-red-500">*</span>
                            </label>
                            <select id="campaign_type" name="campaign_type" required
                                    class="w-full rounded-lg border border-gray-300 px-3 py-2.5 text-sm shadow-sm focus:border-primary-500 focus:outline-none focus:ring-1 focus:ring-primary-500">
                                <option value="">{{ __('partner.campaign_offers.select_type') }}</option>
                                <option value="product_promotion" {{ old('campaign_type') === 'product_promotion' ? 'selected' : '' }}>{{ __('partner.campaign_offers.types.product_promotion') }}</option>
                                <option value="store_promotion"   {{ old('campaign_type') === 'store_promotion'   ? 'selected' : '' }}>{{ __('partner.campaign_offers.types.store_promotion') }}</option>
                                <option value="brand_deal"        {{ old('campaign_type') === 'brand_deal'        ? 'selected' : '' }}>{{ __('partner.campaign_offers.types.brand_deal') }}</option>
                                <option value="product_specific"  {{ old('campaign_type') === 'product_specific'  ? 'selected' : '' }}>{{ __('partner.campaign_offers.types.product_specific') }}</option>
                                <option value="flash_sale"        {{ old('campaign_type') === 'flash_sale'        ? 'selected' : '' }}>{{ __('partner.campaign_offers.types.flash_sale') }}</option>
                            </select>
                        </div>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1.5" for="description">
                                {{ __('partner.campaign_offers.description_label') }}
                            </label>
                            <textarea id="description" name="description" rows="3" maxlength="2000"
                                      class="w-full rounded-lg border border-gray-300 px-3 py-2.5 text-sm shadow-sm focus:border-primary-500 focus:outline-none focus:ring-1 focus:ring-primary-500"
                                      placeholder="{{ __('partner.campaign_offers.description_placeholder') }}">{{ old('description') }}</textarea>
                        </div>

                        {{-- Requirements --}}
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1.5" for="requirements">
                                {{ __('partner.campaign_offers.requirements_label') }}
                            </label>
                            <textarea id="requirements" name="requirements" rows="3" maxlength="2000"
                                      class="w-full rounded-lg border border-gray-300 px-3 py-2.5 text-sm shadow-sm focus:border-primary-500 focus:outline-none focus:ring-1 focus:ring-primary-500"
                                      placeholder="{{ __('partner.campaign_offers.requirements_placeholder') }}">{{ old('requirements') }}</textarea>
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-5 sm:grid-cols-3">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1.5" for="starts_at">
                                    {{ __('partner.campaign_offers.start_date') }} <span class="text-red-500">*</span>
                                </label>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1.5" for="ends_at">
                                    {{ __('partner.campaign_offers.end_date') }} <span class="text-red-500">*</span>
                                </label>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1.5" for="invitation_deadline">
                                    {{ __('partner.campaign_offers.invite_deadline') }}
                                </label>
                                <input type="date" id="invitation_deadline" name="invitation_deadline" value="{{ old('invitation_deadline') }}"
                                       class="w-full rounded-lg border border-gray-300 px-3 py-2.5 text-sm shadow-sm focus:border-primary-500 focus:outline-none focus:ring-1 focus:ring-primary-500">
                                <p class="mt-1 text-xs text-gray-400">{{ __('partner.campaign_offers.invite_deadline_hint') }}</p>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1.5" for="attribution_model">
                                    {{ __('partner.campaign_offers.attribution_model') }} <span class="text-red-500">*</span>
                                </label>
                                <select id="attribution_model" name="attribution_model" required
                                        class="w-full rounded-lg border border-gray-300 px-3 py-2.5 text-sm shadow-sm focus:border-primary-500 focus:outline-none focus:ring-1 focus:ring-primary-500">
                                    <option value="last_click"  {{ old('attribution_model', 'last_click') === 'last_click'  ? 'selected' : '' }}>{{ __('partner.campaign_offers.attribution.last_click') }}</option>
                                    <option value="first_click" {{ old('attribution_model') === 'first_click' ? 'selected' : '' }}>{{ __('partner.campaign_offers.attribution.first_click') }}</option>
                                    <option value="linear"      {{ old('attribution_model') === 'linear'      ? 'selected' : '' }}>{{ __('partner.campaign_offers.attribution.linear') }}</option>
                                </select>
                            </div>
                            <div class="flex items-center gap-3 pt-6">
                                ...
                                <label class="text-sm font-medium text-gray-700 cursor-pointer" for="whatsapp-toggle">
                                    {{ __('partner.campaign_offers.enable_whatsapp') }}
                                </label>
                            </div>
                        </div>
            ...
            <div class="step-panel hidden" data-panel="2">
                <div class="rounded-xl border border-gray-200 bg-white shadow-sm divide-y divide-gray-100">
                    <div class="px-6 py-4">
                        <h2 class="text-base font-semibold text-gray-900">{{ __('partner.campaign_offers.steps.commission_budget') }}</h2>
                    </div>
                    <div class="px-6 py-5 space-y-5">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1.5" for="offered_commission_rate">
                                {{ __('partner.campaign_offers.commission_rate_label') }} <span class="text-red-500">*</span>
                            </label>
                            ...
                            <p class="mt-2 text-xs text-amber-700 bg-amber-50 border border-amber-200 rounded-lg px-3 py-2">
                                {!! __('partner.campaign_offers.commission_preview', ['rate' => '<strong id="commission-preview">0%</strong>']) !!}
                            </p>
                        </div>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">
                                {{ __('partner.campaign_offers.commission_type_label') }} <span class="text-red-500">*</span>
                            </label>
                            <div class="flex flex-wrap gap-3">
                                @foreach ([
                                    ['value' => 'percentage',      'label' => __('partner.campaign_offers.commission_types.percentage')],
                                    ['value' => 'flat_per_order',  'label' => __('partner.campaign_offers.commission_types.flat_per_order')],
                                    ['value' => 'flat_per_click',  'label' => __('partner.campaign_offers.commission_types.flat_per_click')],
                                ] as $ct)
            ...
            <div class="step-panel hidden" data-panel="3">
                <div class="rounded-xl border border-gray-200 bg-white shadow-sm divide-y divide-gray-100">
                    <div class="px-6 py-4">
                        <h2 class="text-base font-semibold text-gray-900">{{ __('partner.campaign_offers.select_products_title') }}</h2>
                        <p class="text-xs text-gray-500 mt-0.5">{{ __('partner.campaign_offers.select_products_desc') }}</p>
                    </div>
                    <div class="px-6 py-5 space-y-4">

                        {{-- Product search --}}
                        <div class="relative">
                            <input type="text" id="product-search-input" placeholder="{{ __('partner.campaign_offers.product_search_placeholder') }}"
                        ...
                        <p id="no-products-msg" class="hidden text-xs text-red-600">{{ __('partner.campaign_offers.no_products_error') }}</p>
                ...
                <div class="mt-4 rounded-xl border border-gray-200 bg-gray-50 px-6 py-5 space-y-2 text-sm">
                    <h3 class="font-semibold text-gray-800 mb-3">{{ __('partner.campaign_offers.summary_title') }}</h3>
                    <div class="grid grid-cols-2 gap-2 text-gray-600">
                        <span>{{ __('partner.campaign_offers.summary.name') }}</span>        <span id="summary-name" class="font-medium text-gray-900">—</span>
                        <span>{{ __('partner.campaign_offers.summary.type') }}</span>         <span id="summary-type" class="font-medium text-gray-900">—</span>
                        <span>{{ __('partner.campaign_offers.summary.commission') }}</span>       <span id="summary-commission" class="font-medium text-gray-900">—</span>
                        <span>{{ __('partner.campaign_offers.summary.period') }}</span>   <span id="summary-dates" class="font-medium text-gray-900">—</span>
                        <span>{{ __('partner.campaign_offers.summary.products') }}</span>  <span id="summary-products" class="font-medium text-gray-900">—</span>
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-center justify-between pt-2">
                <button type="button" id="btn-prev"
                    ...
                    {{ __('partner.campaign_offers.prev') }}
                </button>
                <div class="flex items-center gap-3 ms-auto">
                    <button type="button" id="btn-next"
                        ...
                        {{ __('partner.campaign_offers.next') }}
                        <svg class="h-4 w-4 rotate-180" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="m9 18 6-6-6-6"/>
                        </svg>
                    </button>
                    <button type="submit" id="btn-save-draft"
                            class="hidden inline-flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-5 py-2.5 text-sm font-semibold text-gray-700 hover:bg-gray-50 transition-colors">
                        {{ __('partner.campaign_offers.save_draft') }}
                    </button>
                    <button type="submit" id="btn-save-invite"
                        ...
                        {{ __('partner.campaign_offers.save_invite') }}
                    </button>
                </div>
            </div>
