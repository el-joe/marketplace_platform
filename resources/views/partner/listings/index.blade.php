...
@section('content')
        ...
        <div class="flex items-center overflow-x-auto">
            ...
            @php
                $tabMap = [
                    ...
                    'paused' => ['label' => 'موقوف', 'color' => 'text-gray-600'],
                    ...
                    'archived' => ['label' => 'مؤرشف', 'color' => 'text-gray-400'],
                ];
            @endphp
    ...
    <div class="flex flex-wrap items-center justify-between gap-3 mb-4">
        <div class="flex items-center gap-2">
            <div class="relative">
                <input type="text" id="listing-search" placeholder="ابحث باسم المنتج أو SKU..."
        ...
        <div class="flex items-center gap-2">
            ...
            <div id="bulk-actions" class="hidden flex items-center gap-2">
                ...
                <button id="bulk-activate"
                    class="bg-green-600 hover:bg-green-700 text-white text-xs font-medium px-3 py-1.5 rounded-lg transition-colors">تفعيل</button>
                <button id="bulk-pause"
                    class="bg-yellow-500 hover:bg-yellow-600 text-white text-xs font-medium px-3 py-1.5 rounded-lg transition-colors">إيقاف
                    مؤقت</button>
                <button id="bulk-archive"
                    class="bg-gray-500 hover:bg-gray-600 text-white text-xs font-medium px-3 py-1.5 rounded-lg transition-colors">أرشفة</button>
            </div>
