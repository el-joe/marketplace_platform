...
@section('page-title', 'Warehouses & Inventory')
...
@section('content')
    ...
    <div class="flex items-center justify-between mb-4">
        <h2 class="text-lg font-semibold text-gray-900">My Warehouses</h2>
    ...
    @if($myWarehouses->isEmpty())
        <div class="bg-white rounded-2xl border border-dashed border-gray-300 p-10 text-center mb-8">
            ...
            <p class="text-gray-600 font-medium mb-1">You don't have a registered warehouse yet</p>
            <p class="text-sm text-gray-400 mb-4">Register your own warehouse to manage stock directly (FBM/FBP fulfillment) instead of sending products to our platform warehouses.</p>
            <a href="{{ route('partner.warehouses.create') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-primary-600 text-white text-sm font-medium rounded-xl hover:bg-primary-700 transition-colors">
                Register a warehouse
            </a>
        </div>
                ...
                <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
                    <div class="p-5 border-b border-gray-100">
                        <div class="flex items-start justify-between">
                            <div>
                                ...
                                <p class="text-xs text-gray-500 mt-0.5">{{ $warehouse->country->name_en }}</p>
                            </div>
                    ...
                    <div class="p-5 grid grid-cols-2 gap-4">
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-xs text-gray-500">SKUs stored</p>
                        </div>
                    </div>
    ...
    <h2 class="text-lg font-semibold text-gray-900 mb-1">Platform Warehouses (Express / FBN)</h2>
    <p class="text-sm text-gray-500 mb-4">Your inventory stored in our warehouses. You can view stock levels here, but adjustments are managed by our warehouse team.</p>
    ...
    @if($platformWarehouses->isEmpty())
        <div class="bg-gray-50 rounded-2xl border border-dashed border-gray-200 p-8 text-center text-gray-400 text-sm">
            You don't have any stock in platform warehouses yet.
            <a href="{{ route('partner.fulfillment.index') }}" class="text-primary-600 hover:underline">Request an inbound shipment →</a>
        </div>
    @else
