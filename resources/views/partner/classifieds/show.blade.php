            ...
            <div class="lg:col-span-2 space-y-4">
                ...
                <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
                    <div class="flex items-center justify-between px-5 py-4 border-b border-gray-100">
                        <h2 class="text-sm font-semibold text-gray-800">الاستفسارات <span id="sh-inquiries-count"
                    ...
                    <div id="sh-inquiries-loading" class="py-8 text-center text-sm text-gray-400">جاري تحميل الاستفسارات...
                    </div>
                    <div id="sh-inquiries-empty" class="hidden py-8 text-center text-sm text-gray-400">لا توجد استفسارات
                        بعد.</div>
            ...
            <div class="space-y-4">
                ...
                <div class="bg-white rounded-2xl border border-gray-200 p-4 text-sm space-y-2.5">
                    ...
                    <div id="sh-sketch-row" style="display:none" class="flex justify-between items-center">
                        ...
                        <a id="sh-sketch-link" href="#" target="_blank" class="text-primary-600 text-xs hover:underline">عرض
                            الملف</a>
                    </div>
                </div>
        ...
        <div
            ...
            <div class="flex-1 overflow-y-auto px-6 py-4 space-y-4">
                ...
                <div id="sh-contract-modal-body" class="hidden space-y-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">اسمك الكامل (للتوقيع) <span
