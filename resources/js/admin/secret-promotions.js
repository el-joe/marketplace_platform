...
function initTable() {
    ...
    table = new DataTable('#secret-promos-table', {
        ...
        columns: [
            ...
            { data: 'marketer',      title: 'Marketer', orderable: false },
            { data: 'listing_price', title: 'Listing Price' },
            { data: 'product_value', title: '🔒 Product Value', orderable: false, className: 'bg-amber-50 text-amber-800' },
            { data: 'margin_pct',    title: '🔒 Margin %', orderable: false, className: 'bg-amber-50 text-amber-700' },
            { data: 'total_pct',     title: 'Total %' },
            { data: 'marketer_pct',  title: 'Marketer %' },
            { data: 'admin_pct',     title: '🔒 Admin %', orderable: false, className: 'bg-amber-50 text-amber-700 font-bold' },
            { data: 'conversions',   title: 'Conv.', orderable: false },
